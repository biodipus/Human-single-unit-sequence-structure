# -*- coding: utf-8 -*-
"""
Created on Fri Dec 16 13:58:44 2022
...
class My_supervised_PCA:
    ...
    def fit_transform(self, X, Y):
        ...
        eig_val = self.V
        eig_vec = self.U
        return X_transformed, eig_val, eig_vec, self.V_raw, self.U_raw
    ...
    def fit(self, X, Y):
        ...
        # self.V_raw = eig_val.copy()
        # self.U_raw = eig_vec.copy()
    ...
    def recon(self, transX, Y=None):
        reconDataMat = (self.U).dot(transX) + self.mean_of_X
        return reconDataMat
    ...
    def center_the_matrix(self, the_matrix, mode="double_center"):
        ...
        H_left = np.eye(n_rows) - ((1/n_rows) *
                                   vector_one_left.dot(vector_one_left.T))
        H_right = np.eye(n_cols) - ((1 / n_cols) *
                                    vector_one_right.dot(vector_one_right.T))
